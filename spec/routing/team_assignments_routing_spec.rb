...
RSpec.describe TeamAssignmentsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(get: "/team_assignments/new").to route_to("team_assignments#new")
    end
    ...
    it "routes to #edit" do
      expect(get: "/team_assignments/1/edit").to route_to("team_assignments#edit", id: "1")
    end
